defmodule ModifierTest do
  use ExUnit.Case
  import AssertValue
  doctest KSA.Modifier

  describe "We can remove modifiers - " do
    test "한표" do
      assert_value(KSA.Modifier.remove("한표") == "표")
    end
  end

  describe "We can find modifiers directly - " do
    test "한표" do
      assert_value KSA.Modifier.find("한표") == [
    ...
    test "다섯개" do
      assert_value KSA.Modifier.find("다섯개") == [
    ...
    test "3구" do
      assert_value KSA.Modifier.find("3구") == %{"specific_type" => "Modifier", "token" => "구", "type" => "Modifier"}
    end

    test "중랑구는" do
      # This is not a modifier, so should return nil
      assert_value KSA.Modifier.find("중랑구는") == nil
    end

    test "세개" do
      assert_value KSA.Modifier.find("세개") == [
